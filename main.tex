...
\begin{frame}{Performance of selected systems}
    ...
    \begin{block}{Machine Translation (To English)}
       Prefers utility over linguistic variety. Translations systems are more available for languages where users use such a system frequently.
    \end{block}
\end{frame}

\begin{frame}{Performance of selected systems (contd.)}
    \begin{block}{Question Answering and Natural Language Inference}
        Cover around 15 to 17 languages. Again, affected by demography over language variety. 
    \end{block}
    
    \begin{block}{Syntatic Parsing and Morphological Inflection}
...
\begin{frame}{Commercial Aspects}
    \begin{itemize}
        ...
        \item "Economic prowess" of the users of a language
    \end{itemize}
\end{frame}

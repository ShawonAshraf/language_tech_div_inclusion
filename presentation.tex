...
\begin{frame}{Question Answering}
    \begin{itemize}
        \item Results from TyDi-QA and MLQA benchmarks
...
\begin{frame}
\frametitle{Tools vs Language usage}
...
\begin{frame}{Curious Questions}
    \begin{itemize}
        ...
        \item Why do linguistic tasks perform better on languages with less NLP tools?
    \end{itemize}
\end{frame}
